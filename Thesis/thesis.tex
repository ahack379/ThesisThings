...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{NewFigures/NeutrinoModeProduction_Eranges.png}
\hspace{6 mm}
\includegraphics[scale=0.5]{NewFigures/Resonance.png}
