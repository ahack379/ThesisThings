...
\includegraphics[scale=0.3]{Hardware/beamline0.png}
  ...
  \begin{subfigure}[t]{0.6\textwidth}
    \centering
\includegraphics[scale=0.6]{Hardware/target0.png}
  \caption{ }
  \end{subfigure} 
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Hardware/beamline_to_uboone.png}
...
\centering
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
\includegraphics[scale=0.45]{Hardware/cryo.png}
  \caption{ }
  \end{subfigure} 
  %\hspace{1mm}
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
\includegraphics[scale=0.5]{Hardware/cryo2.png}
  \caption{ }
  \end{subfigure} 
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[scale=0.45]{Hardware/tpb0.png}}
\hspace{1 mm}
\fbox{\includegraphics[scale=0.31]{Hardware/lightExcitement}} %decayTime.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[scale=0.28]{Hardware/lightRatio.png}}
\hspace{2 mm}
\fbox{\includegraphics[scale=0.4]{Hardware/decayTime.png}}
