...
% From here, we see that 93\% of our sample has 2 selected candidate showers that backtrack to true $\nu$-induced $\pi^0$'s, while nearly all of the remaining 7\% have at least 1 candidate shower that tracks to a true $\nu$-induced $\pi^0$. 
