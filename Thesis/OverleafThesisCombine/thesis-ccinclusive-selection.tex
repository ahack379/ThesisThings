...
%   \caption{ }
%  \end{subfigure} 
%\caption{Multiplicity 1 data-MC comparisons of a) $\frac{dE}{dx}$ ratio; b) projected length in y }
...
%The 1D distributions of each variable are shown in Figures \ref{fig:cutjust_sel2_multgt1_tracklen1} and \ref{fig:cutjust_sel2_multgt1_dcosy}. 
...
%\begin{figure}[H]
% \begin{subfigure}[t]{0.37\textwidth}
%\includegraphics[scale=0.37]{Selection_II_Section/CutJustify_sel2_multgt1_tracklen1.png}
% \caption{ }
%  \end{subfigure} 
%  \hspace{25mm}
%  \begin{subfigure}[t]{0.37\textwidth}
%\includegraphics[scale=0.37]{Selection_II_Section/CutJustify_sel2_datamc_multgt1_tracklen1.png}
% \caption{ }
%  \end{subfigure} 
